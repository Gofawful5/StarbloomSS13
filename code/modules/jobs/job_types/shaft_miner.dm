/datum/job/shaft_miner
	...
	outfit = /datum/outfit/job/shaft_miner
	plasmaman_outfit = /datum/outfit/plasmaman/shaft_miner

	paycheck = PAYCHECK_MEDIUM
	paycheck_department = ACCOUNT_CAR

	display_order = JOB_DISPLAY_ORDER_SHAFT_MINER
	bounty_types = CIV_JOB_MINER
...
/datum/outfit/job/shaft_miner
	...
	belt = /obj/item/pda/miner
	ears = /obj/item/radio/headset/headset_cargo/miner
...
/datum/outfit/job/shaft_miner/equipped
...
/datum/outfit/job/shaft_miner/equipped/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	..()
	if(visualsOnly)
		return
...
/datum/outfit/job/shaft_miner/equipped/mod
