...
/datum/id_trim/job/cargo_technician
	...
	extra_access = list(ACCESS_QM, ACCESS_SHAFTMINER, ACCESS_SHAFTMINER_STATION)
...
/datum/id_trim/job/curator
	...
	extra_access = list()
	minimal_access = list(ACCESS_AUX_BASE, ACCESS_LIBRARY, ACCESS_SHAFTMINER_STATION, ACCESS_SERVICE)
	config_job = "curator"
	template_access = list(ACCESS_CAPTAIN, ACCESS_HOP, ACCESS_CHANGE_IDS)
...
/datum/id_trim/job/head_of_personnel
	...
	minimal_access = list(ACCESS_AI_UPLOAD, ACCESS_ALL_PERSONAL_LOCKERS, ACCESS_AUX_BASE, ACCESS_BAR, ACCESS_CARGO, ACCESS_CHAPEL_OFFICE,
					...
					ACCESS_SHAFTMINER, ACCESS_SHAFTMINER_STATION, ACCESS_MORGUE, ACCESS_PSYCHOLOGY, ACCESS_QM, ACCESS_RC_ANNOUNCE,
...
/datum/id_trim/job/head_of_security
	...
	minimal_access = list(ACCESS_ALL_PERSONAL_LOCKERS, ACCESS_ARMORY, ACCESS_AUX_BASE, ACCESS_BRIG, ACCESS_CONSTRUCTION, ACCESS_COURT,
					...
					ACCESS_SHAFTMINER, ACCESS_MORGUE, ACCESS_RC_ANNOUNCE, ACCESS_RESEARCH, ACCESS_SECURITY, ACCESS_BRIG_ENTRANCE, ACCESS_WEAPONS)
...
/datum/id_trim/job/paramedic
	...
	minimal_access = list(ACCESS_CONSTRUCTION, ACCESS_HYDROPONICS, ACCESS_MAINT_TUNNELS, ACCESS_MECH_MEDICAL,
					ACCESS_MEDICAL, ACCESS_MINERAL_STOREROOM, ACCESS_SHAFTMINER, ACCESS_MORGUE, ACCESS_RESEARCH)
...
/datum/id_trim/job/quartermaster
	...
	extra_access = list()
	minimal_access = list(ACCESS_AUX_BASE, ACCESS_CARGO, ACCESS_MAIL_SORTING, ACCESS_MAINT_TUNNELS, ACCESS_MECH_MINING, ACCESS_SHAFTMINER_STATION,
					ACCESS_MINERAL_STOREROOM, ACCESS_SHAFTMINER, ACCESS_QM, ACCESS_RC_ANNOUNCE, ACCESS_VAULT)
...
/datum/id_trim/job/research_director
	...
	minimal_access = list(ACCESS_AI_UPLOAD, ACCESS_AUX_BASE, ACCESS_EVA, ACCESS_GATEWAY, ACCESS_GENETICS, ACCESS_COMMAND, ACCESS_KEYCARD_AUTH,
					...
					ACCESS_MEDICAL, ACCESS_MINERAL_STOREROOM, ACCESS_SHAFTMINER, ACCESS_SHAFTMINER_STATION, ACCESS_MINISAT, ACCESS_MORGUE,
...
/datum/id_trim/job/security_officer/supply
	...
	subdepartment_color = COLOR_CARGO_BROWN
	department_access = list(ACCESS_AUX_BASE, ACCESS_CARGO, ACCESS_MAIL_SORTING, ACCESS_SHAFTMINER, ACCESS_SHAFTMINER_STATION)
...
/datum/id_trim/job/shaft_miner
	...
	minimal_access = list(ACCESS_AUX_BASE, ACCESS_MAIL_SORTING, ACCESS_MECH_MINING, ACCESS_MINERAL_STOREROOM, ACCESS_SHAFTMINER,
					ACCESS_SHAFTMINER_STATION)
...
/datum/id_trim/job/shaft_miner/spare
	extra_access = list()
	minimal_access = list(ACCESS_MAIL_SORTING, ACCESS_MECH_MINING, ACCESS_MINERAL_STOREROOM, ACCESS_SHAFTMINER, ACCESS_SHAFTMINER_STATION)
	template_access = null
