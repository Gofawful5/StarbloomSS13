...
#define ACCESS_SHAFTMINER_STATION "shaftminer_station"
#define ACCESS_VAULT "vault"
#define ACCESS_QM "qm"
#define ACCESS_SHAFTMINER "miner"
...
#define ACCESS_SYNDICATE_LEADER "edict_leader"
/// BLOODCULT
...
/// Syndicate areas. Do not use direct, access via SSid_access.get_flag_access_list(ACCESS_FLAG_SYNDICATE)
...
#define PDA_PAINTING_REGIONS list( \
	...
	/obj/item/pda/miner = list(REGION_SUPPLY), \
