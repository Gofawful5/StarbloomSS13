...
/datum/opposing_force_equipment/clothing/syndiebag
	...
	name = "Syndicate Suspicious Duffelbag"
...
/datum/opposing_force_equipment/clothing/infiltrator
	name = "Syndicate Infiltrator Gear"
...
/datum/opposing_force_equipment/clothing/nukiemod
	name = "Syndicate MODsuit" // YOU MUST WEAR THE MODSUIT
	item_type = /obj/item/mod/control/pre_equipped/nuclear
	description = "A modified scrapper modsuit produced by the Syndicate. Offers good armor and basic modules to get the job done."
