...
/datum/laugh_type/human
	...
	female_laughsounds = list('topiastation_modules/emotes/sound/emotes/female/female_giggle_1.ogg',
					'topiastation_modules/emotes/sound/emotes/female/female_giggle_2.ogg')
