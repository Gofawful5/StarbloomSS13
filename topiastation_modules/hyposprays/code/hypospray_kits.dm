/obj/item/storage/hypospraykit
	name = "hypospray kit"
	desc = "It's a kit containing a hypospray and refillable vials."
	icon = 'topiastation_modules/hyposprays/icons/hypokits.dmi'
	...
	throw_speed = 3
	throw_range = 7
	/// Does the kit start empty?
	var/empty = FALSE
	/// Currently selected case design
	var/current_case = "firstaid"
	/// List of possible standard case designs
	var/static/list/case_designs
	/// Is it a CMO edition case?
	var/cmo_case = FALSE
	/// List of possible CMO case designs
