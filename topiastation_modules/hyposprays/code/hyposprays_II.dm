...
/obj/item/hypospray/mkii
	...
	icon_state = "hypo2"
	icon = 'topiastation_modules/hyposprays/icons/hyposprays.dmi'
...
/obj/item/hypospray/mkii/update_overlays()
	...
	if(!small_only)
		...
		vial_spritetype += "-s"
	var/mutable_appearance/chem_loaded = mutable_appearance('topiastation_modules/hyposprays/icons/hyposprays.dmi', vial_spritetype)
...
/obj/item/hypospray/mkii/update_icon_state()
	...
	var/icon_suffix = "-s"
	if(!small_only && vial)
		icon_suffix = vial.type_suffix //Sets the suffix used to the corresponding vial.
...
/obj/item/hypospray/mkii/afterattack(atom/target, mob/living/user, proximity)
	...
	playsound(loc, long_sound ? 'topiastation_modules/hyposprays/sound/hypospray_long.ogg' : pick('topiastation_modules/hyposprays/sound/hypospray.ogg','topiastation_modules/hyposprays/sound/hypospray2.ogg'), 50, 1, -1)
