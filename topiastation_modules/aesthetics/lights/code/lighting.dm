/obj/machinery/light
	icon = 'topiastation_modules/aesthetics/lights/icons/lighting.dmi'
	overlay_icon = 'topiastation_modules/aesthetics/lights/icons/lighting_overlay.dmi'
...
/obj/machinery/light/proc/turn_on(trigger, play_sound = TRUE)
	...
	if(!matching)
		...
		if(rigged)
			...
			set_light(BR, PO, CO)
			if(play_sound)
				playsound(src.loc, 'topiastation_modules/aesthetics/lights/sound/light_on.ogg', 65, 1)
